...
Puerto is a curated marketplace organized as a digital agency team for Claude Code. It provides **8 functional departments with 27 specialized roles** that extend Claude's capabilities with commands, agents, skills, hooks, and MCP servers.
...
**Agents:** Autonomous subagents Claude invokes (e.g., `frontend-engineer`)
