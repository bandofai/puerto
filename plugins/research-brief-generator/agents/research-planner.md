...
description: Defines comprehensive research scope, methodology, and data collection strategy. Creates structured research plans with source identification, comparison criteria, and decision framework selection.
