...
description: Performs deep comparative analysis of research data. Creates comparison matrices, SWOT analyses, scoring frameworks, and synthesizes pros/cons. Applies decision frameworks to generate data-driven insights.
