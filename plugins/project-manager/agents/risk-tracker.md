---
name: risk-tracker
description: Identifies, assesses, and tracks project risks with mitigation strategies. Uses probability-impact analysis and risk matrices for comprehensive risk management.
