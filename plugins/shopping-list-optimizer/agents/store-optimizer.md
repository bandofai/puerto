...
description: Use after shopping list creation to optimize shopping routes. Maps store layouts, plans efficient paths to minimize walking distance, and provides multi-store comparison for best shopping strategy.
