...
description: Use when comparing prices across stores for shopping list items. Tracks multi-store prices, identifies best value options, calculates potential savings, and recommends optimal purchasing strategy.
