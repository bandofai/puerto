...
description: MUST BE USED when generating insurance documentation. Creates PDF reports with room-by-room inventory lists and total value calculations for insurance claims.
