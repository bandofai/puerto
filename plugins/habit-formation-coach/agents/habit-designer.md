---
name: habit-designer
description: PROACTIVELY use when user wants to build a new habit. Creates science-based habit plans using BJ Fogg Behavior Model, tiny habits methodology, and implementation intentions.
