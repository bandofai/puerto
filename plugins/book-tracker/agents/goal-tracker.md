---
name: goal-tracker
description: PROACTIVELY use for reading goal management and annual challenges. Sets/updates goals (books, pages, genres), tracks progress, provides pace analysis, suggests adjustments, and celebrates milestones.
...
**IMPORTANT**: Always invoke the `reading-management` skill when setting or tracking reading goals to access best practices for goal-setting, progress tracking, and motivational strategies.
