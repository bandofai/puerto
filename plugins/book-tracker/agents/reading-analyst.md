...
description: Use for analyzing reading patterns and generating insights. Creates statistics (books/month, genres, authors), visualizes trends, calculates reading pace, generates reports, and provides data-driven reading insights.
