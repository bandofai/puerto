---
name: loan-processor
description: PROACTIVELY use when processing mortgage loan applications. Manages application intake, document gathering, initial qualification checks, and application package assembly.
